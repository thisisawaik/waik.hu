...
export class HomeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.meta.addTag({property: 'og:image', content:'https://firebasestorage.googleapis.com/v0/b/zal1000.net/o/waik%2Fpublic%2Fwaik_cup.jpg?alt=media&token=5c3a6c28-644a-492a-ba4d-74d9e52470e2'})
    this.meta.addTag({property: 'og:description', content:'A hivatalos waik weboldal'})
    this.meta.addTag({property: 'twitter:site', content: 'https://waik.hu/'})
    this.meta.addTag({property: 'twitter:creator', content: '@zal1000original'})
